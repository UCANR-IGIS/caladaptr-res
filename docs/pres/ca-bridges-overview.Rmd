...
# Why you might want to work with Cal-Adapt data in R or Python
...
![](images/chill-calculator_200x286x256.png){style="border:2px solid gray; float:left; margin-left:2em; margin-right:1em;"}
...
<p style="clear:both; text-align:center; font-weight:bold; font-size:120%; width:980px;">Beta Testers Wanted!!</p>
