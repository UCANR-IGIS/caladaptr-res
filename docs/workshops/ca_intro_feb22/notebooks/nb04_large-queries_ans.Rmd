---
title: "Large Queries and Caching Results"
output:
  html_notebook: 
...
- caching retrieved into a SQLite database  
- downloading data as TIFFs
...
```{r chunk18, paged.print = FALSE, cache=FALSE}
