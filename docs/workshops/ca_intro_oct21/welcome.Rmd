...
A second monitor is strongly recommended so you can view the instructor's screen in one monitor while you run R on the other. A tablet might suffice as your 'Zoom' device while you run R on your laptop. If you're truly limited to just one screen, check out [these tips](workspace_tips.html) for viewing Zoom and an application window side-by-side.
