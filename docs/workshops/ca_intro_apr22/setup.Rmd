...
You can create a free account on [**RStudio Cloud**](https://rstudio.cloud/){target="_blank" rel="noopener"} using an email address or your Google or GitHub credentials. The free plan offers 25 hours of usage per month, which is more than enough for the workshop. Once your account is setup, you're done for now.  

If you want to verify its working, you can open [this project](https://rstudio.cloud/project/3567507){target="_blank" rel="noopener"} and open the sample script *caladaptr_test.R* to fetch and plot some Cal-Adapt climate data. 

The day before the workshop, the instructor will send out a link for the workshop VM, which you can click on to make a copy of it in your ow  n RStudio Cloud workspace. All the required packages, R notebooks, and data will be ready to go.

<!-------------------------
To make your own copy of the workshop project, click on this link: [**https://rstudio.cloud/project/3606612**](https://rstudio.cloud/project/3606612){target="_blank" rel="noopener"}. After the project opens in your RStudio Cloud workspace, click the 'Save a permanent copy' button. To find the exercise Notebooks, click on th 'Notebooks' directory in the files pane in RStudio.
---------------------->
...
On the day of the workshop, the instructor will provide a link to the data and exercises.

<!-----------------------

Run the following lines to download the slides and notebooks. (You can also download the zip file from a browser). The zip file is about 30MB.

<div class="indented1">
```{r download_materials, eval = FALSE}
zip_url <- "https://ucdavis.box.com/shared/static/uxj3nzhk4aagtsc6mpbnq4buhh0j1mgm.zip"

## Update destdir to where you want the workshop folder to go, or omit it to expand to the desktop
