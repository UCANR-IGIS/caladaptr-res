...
The first thing we do is to load caladaptR and the other package we're going to need. (If you haven't installed these yet, see this [setup script](https://github.com/ucanr-igis/caladaptr-res/blob/main/docs/workshops/ca_intro_apr22/scripts/caladaptr_setup.R)). 
...
For the same point, make a plot of average maximum daily temperature year for the same 4 GCMs for the period 1950-2005. [[Hint](https://bit.ly/3oWB12V)]. [[Answer](https://bit.ly/3I3ZVp2)].
